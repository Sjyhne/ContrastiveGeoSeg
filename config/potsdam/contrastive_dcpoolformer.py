...
model = ContrastiveDCPoolFormer(config=config, attn_loss=attn_loss, contrastive_loss=con_loss)
...
# weights and biases
wandb_logging_name = f"DCPoolFormer Contrastive w/positive & clipping NEW"
wandb_project = f"Potsdam DCPoolFormer {dp}"
wandblogger = True
