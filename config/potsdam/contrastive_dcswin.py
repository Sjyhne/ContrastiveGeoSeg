...
# detach for more stable training
detach = None # None for False

# weights and biases
wandb_logging_name = f"DCSwin Contrastive (clip {con_loss_clip}) (bs {train_batch_size}, lr {learning_rate})"
wandb_project = f"CT-DCSwin New S"
wandblogger = True
...
model = ContrastiveDCSwin(config=config, contrastive_loss=con_loss)
