...
class DAttentionBaseline(nn.Module):
    ...
    def __init__(
        ...
        self.patch_size = [4, 8, 16, 32][stage_idx]
    ...
    def forward(self, x):
        ...
        attn = F.softmax(attn, dim=2)
         ...
         # (2, 4096, 4096), (2, 128, 4096) -> (2, 128, 4096)
        ...
        return y, offset.reshape(B, Hk, Wk, self.n_groups, 2).mean(-2), pos.reshape(B, self.n_groups, Hk, Wk, 2), reference.reshape(B, self.n_groups, Hk, Wk, 2)