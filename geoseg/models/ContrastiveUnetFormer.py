...
from .UNetFormer import Decoder
...
class ContrastiveUnetFormer(nn.Module):
        ...
        for c in classes:
            ...
            for i in self.contrastive_indices.to(current_device):
                ...
                if self.loss_type == "contrastive":
                    ...
                    con_loss += self.binary_supcon_loss(pos_feats, neg_feats, current_device)
    ...
    def alt_binary_contrastive(self, features, mask, type="train"):
        ...
        for i in self.contrastive_indices.to(current_device):
            ...
            for c in classes:
                ...
                not_class_features = feats[cindex_mask < 0.1] 
