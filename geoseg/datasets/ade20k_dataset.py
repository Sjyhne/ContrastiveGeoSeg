...
class ADE20KDataset(Dataset):
    def __init__(self, data_root='data/ade20k/test', mode='val', img_dir='images', mask_dir='masks',
        ...
        if data_percentage != 1.:
            ...
            self.img_ids = self.img_ids[:int(len(self.img_ids) * data_percentage)]
    ...
    def __getitem__(self, index):
        ...
        img = torch.from_numpy(img).contiguous().permute(2, 0, 1).float()
